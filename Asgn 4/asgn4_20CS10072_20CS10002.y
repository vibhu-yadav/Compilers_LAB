...
%token LOGICAL_AND LOGICAL_OR TERNARY COLON SEMICOLON ELLIPSES 
%token ASSIGNMENT  MULTIPLY_ASSIGNMENT  DIVIDE_ASSIGNMENT  MODULO_ASSIGNMENT  ADD_ASSIGNMENT  SUBTRACT_ASSIGNMENT  LEFT_SHIFT_ASSIGNMENT  RIGHT_SHIFT_ASSIGNMENT  AND_ASSIGNMENT  XOR_ASSIGNMENT  OR_ASSIGNMENT  COMMA HASH
...
type_specifier: VOID
              ...
              | _BOOL
                    { printf("type-specifier => __BOOL\n"); }
              | _COMPLEX
                    { printf("type-specifier => __COMPLEX\n"); }
              | _IMAGINARY
                    { printf("type-specifier => __IMAGINARY\n"); }
              | enum_specifier
...
void yyerror(char *s) {
      printf("Error of type \"%s\" occurred at Line No. %d. Parsing terminated :(\n", s, lines);
}